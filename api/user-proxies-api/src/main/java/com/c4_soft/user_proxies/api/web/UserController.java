...
public class UserController {
	...
	@PreAuthorize("#auth.name == #subject or hasAnyAuthority('TOKEN_ISSUER', 'USERS_ADMIN') or onBehalfOf(#subject).can('READ_PROXIES')")
	...
	@PreAuthorize("#auth.name == #subject or hasAnyAuthority('USERS_ADMIN') or onBehalfOf(#subject).can('READ_PROXIES')")
	...
	@PreAuthorize("#auth.name == #grantingUserSubject or hasAuthority('USERS_ADMIN') or onBehalfOf(#grantingUserSubject).can('EDIT_PROXIES')")
